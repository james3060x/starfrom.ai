-- =====================================================
-- StarFrom AI - Supabase 数据库初始化 SQL
-- =====================================================
-- 
-- 使用方法:
...
-- 现在你可以：
-- 1. 查看表结构：\dt
-- 2. 查看模块数据：SELECT * FROM service_modules;
-- 3. 查看案例数据：SELECT * FROM service_cases;
